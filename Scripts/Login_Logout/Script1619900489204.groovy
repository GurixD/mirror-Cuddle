...
WebUI.click(findTestObject('Object Repository/Page_Cuddle/a_Login'))
...
WebUI.click(findTestObject('Object Repository/Page_Cuddle/a_antoine.lestradehe-arc.ch'))

Util.jsClick(findTestObject('Object Repository/Page_Cuddle/a_Logout'))
